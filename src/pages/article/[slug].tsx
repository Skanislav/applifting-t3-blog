...
import {Container, Divider, Grid, Group, Space, Stack, Title} from "@mantine/core";
...
export default function ArticleDetailPage({slug}: InferGetServerSidePropsType<typeof getServerSideProps>) {
    if (!slug) return null;
        ...
        <Container size={'xl'}>
            ...
            <Grid h={'100%'} w={'100%'} columns={3}>
                <Grid.Col span={2}>
                    ...
                    {article.status === 'error' && <div>Error: {article.error.message}</div>}
                ...
                <Grid.Col span={1}>
                    <Group>
                        ...
                        <Stack  w={346} ml={'auto'}>
                            <Title order={3} size={24} weight={500}>Related articles</Title>
                        </Stack>
                    </Group>
                </Grid.Col>
            </Grid>
