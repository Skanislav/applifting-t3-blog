...
import {Box, Flex, Group, Space, Stack, Text, UnstyledButton} from "@mantine/core";
...
export const ArticlePreview = ({ article }: ArticlePreviewProps) => {
    return <Flex gap={24}>
        {article.image_url && <Image width={272} height={244} src={article.image_url} alt={'article-image'}/>}
        <Stack w={557}>
